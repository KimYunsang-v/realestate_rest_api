...
//    @Around("execution(* kr.ac.skuniv.realestate.service.GraphService.*(..))")
//    public Object getGraphList(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
//        Object result = proceedingJoinPoint.proceed();//TARGET 메소드
//
////        try{
